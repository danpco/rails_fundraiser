...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { begins: @auction.begins, ends: @auction.ends, title: @auction.title, user_id: @auction.user_id }
    end
  ...
  test "should update auction" do
    patch :update, id: @auction, auction: { begins: @auction.begins, ends: @auction.ends, title: @auction.title, user_id: @auction.user_id }
    assert_redirected_to auction_path(assigns(:auction))
  end
